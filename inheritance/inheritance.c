...
// Choose a random allele from a given parent
...
person *create_family(int generations)
{
    ...
    if (generations > 1)
    {
        ...
        Person->alleles[0] = random_parent_allele(*parent0);
        Person->alleles[1] = random_parent_allele(*parent1);
    }
